        ...
        public FirebaseService()
        {
            try
            {
                ...
                string[] possiblePaths = {
                    Path.Combine(Directory.GetCurrentDirectory(), "Config", "worldtrek-86213-firebase-adminsdk-fbsvc-8d2b539f08.json"),
                    Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Config", "worldtrek-86213-firebase-adminsdk-fbsvc-8d2b539f08.json"),
                    "Config/worldtrek-86213-firebase-adminsdk-fbsvc-8d2b539f08.json"
                };
